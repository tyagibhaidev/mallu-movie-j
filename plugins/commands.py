...
async def start(client, message):
    if message.chat.type in ['group', 'supergroup']:
        buttons = [
            [
                InlineKeyboardButton('🤖 Updates', url='https://t.me/mallumoviegrup')
            ],
            [
        ...
        await asyncio.sleep(2) # 😢 https://t.me/mallumoviegrup/blob/master/plugins/p_ttishow.py#L17 😬 wait a bit, before checking.
